...
python main.py --which_splits 5foldcv --split_dir tcga_blca --mode pathomic --reg_type pathomic --model_type porpoise_mmf --data_root_dir /scratch/project_2003204/zrx/results/LUAD/feature/ --modality P
python main.py --which_splits 5foldcv --split_dir tcga_blca --mode pathomic --reg_type pathomic --model_type porpoise_mmf --data_root_dir /scratch/project_2003204/zrx/results/LUAD/feature/ --modality G
